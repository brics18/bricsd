...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"brics", util.Bech32PrefixKaspa, false},
		{"bricstest", util.Bech32PrefixKaspaTest, false},
		{"bricssim", util.Bech32PrefixKaspaSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixKaspa, "brics"},
		{util.Bech32PrefixKaspaTest, "bricstest"},
		{util.Bech32PrefixKaspaSim, "bricssim"},
		{util.Bech32PrefixUnknown, ""},
	}
