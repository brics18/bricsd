...
// SignatureScript creates an input signature script for tx to spend BRICS sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend BRICS sent
