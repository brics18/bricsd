...
import (
	...
	"github.com/brics18/bricsd/domain/consensus/datastructures/blockwindowheapslicestore"
	"github.com/brics18/bricsd/domain/consensus/datastructures/daawindowstore"
	"github.com/brics18/bricsd/domain/consensus/datastructures/mergedepthrootstore"
	"github.com/brics18/bricsd/domain/consensus/model"
	"github.com/brics18/bricsd/domain/consensus/processes/blockparentbuilder"
	parentssanager "github.com/brics18/bricsd/domain/consensus/processes/parentsmanager"
	"github.com/brics18/bricsd/domain/consensus/processes/pruningproofmanager"
	...
	consensusdatabase "github.com/brics18/bricsd/domain/consensus/database"
	"github.com/brics18/bricsd/domain/consensus/datastructures/acceptancedatastore"
	"github.com/brics18/bricsd/domain/consensus/datastructures/blockheaderstore"
	"github.com/brics18/bricsd/domain/consensus/datastructures/blockrelationstore"
	"github.com/brics18/bricsd/domain/consensus/datastructures/blockstatusstore"
	"github.com/brics18/bricsd/domain/consensus/datastructures/blockstore"
	"github.com/brics18/bricsd/domain/consensus/datastructures/consensusstatestore"
	"github.com/brics18/bricsd/domain/consensus/datastructures/daablocksstore"
	"github.com/brics18/bricsd/domain/consensus/datastructures/finalitystore"
	"github.com/brics18/bricsd/domain/consensus/datastructures/ghostdagdatastore"
	"github.com/brics18/bricsd/domain/consensus/datastructures/headersselectedchainstore"
	"github.com/brics18/bricsd/domain/consensus/datastructures/headersselectedtipstore"
	"github.com/brics18/bricsd/domain/consensus/datastructures/multisetstore"
	"github.com/brics18/bricsd/domain/consensus/datastructures/pruningstore"
	"github.com/brics18/bricsd/domain/consensus/datastructures/reachabilitydatastore"
	"github.com/brics18/bricsd/domain/consensus/datastructures/utxodiffstore"
	"github.com/brics18/bricsd/domain/consensus/model/externalapi"
	"github.com/brics18/bricsd/domain/consensus/model/testapi"
	"github.com/brics18/bricsd/domain/consensus/processes/blockbuilder"
	"github.com/brics18/bricsd/domain/consensus/processes/blockprocessor"
	"github.com/brics18/bricsd/domain/consensus/processes/blockvalidator"
	"github.com/brics18/bricsd/domain/consensus/processes/coinbasemanager"
	"github.com/brics18/bricsd/domain/consensus/processes/consensusstatemanager"
	"github.com/brics18/bricsd/domain/consensus/processes/dagtopologymanager"
	"github.com/brics18/bricsd/domain/consensus/processes/dagtraversalmanager"
	"github.com/brics18/bricsd/domain/consensus/processes/difficultymanager"
	"github.com/brics18/bricsd/domain/consensus/processes/finalitymanager"
	"github.com/brics18/bricsd/domain/consensus/processes/ghostdagmanager"
	"github.com/brics18/bricsd/domain/consensus/processes/headersselectedtipmanager"
	"github.com/brics18/bricsd/domain/consensus/processes/mergedepthmanager"
	"github.com/brics18/bricsd/domain/consensus/processes/pastmediantimemanager"
	"github.com/brics18/bricsd/domain/consensus/processes/pruningmanager"
	"github.com/brics18/bricsd/domain/consensus/processes/reachabilitymanager"
	"github.com/brics18/bricsd/domain/consensus/processes/syncmanager"
	"github.com/brics18/bricsd/domain/consensus/processes/transactionvalidator"
