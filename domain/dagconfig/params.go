...
import (
	...
	"github.com/brics18/bricsd/util/network"
...
// Params defines a Brics network by its parameters. These parameters may be
// used by Brics applications to differentiate networks as well as addresses
...
// MainnetParams defines the network parameters for the main Brics network.
var MainnetParams = Params{
	...
	DefaultPort: "18111",
	DNSSeeds: []string{
		"brics-seeder1.online",
		"brics-seeder2.online",
		"brics-seeder3.online",
		"brics-pro.online",
	},
...
// TestnetParams defines the network parameters for the test Brics network.
var TestnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "brics-testnet-10",
...
// SimnetParams defines the network parameters for the simulation test Brics
...
// DevnetParams defines the network parameters for the development Brics network.
...
// ErrDuplicateNet describes an error where the parameters for a Brics
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Brics network")

var registeredNets = make(map[appmessage.KaspaNet]struct{})

// Register registers the network parameters for a Brics network. This may
