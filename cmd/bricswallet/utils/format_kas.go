...
// FormatKas takes the amount of sompis as uint64, and returns amount of BRICS with 8  decimal places
...
// KasToSompi takes in a string representation of the Brics value to convert to Sompi
