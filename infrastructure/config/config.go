...
const (
	defaultConfigFilename      = "bricsd.conf"
	defaultLogLevel            = "info"
	defaultLogDirname          = "logs"
	defaultLogFilename         = "bricsd.log"
	defaultErrLogFilename      = "bricsd_err.log"
...
var (
	// DefaultAppDir is the default home directory for bricsd.
	DefaultAppDir = util.AppDir("bricsd", false)
...
// Flags defines the configuration options for bricsd.
//
...
// Config defines the configuration options for bricsd.
//
// See loadConfig for details on the configuration load process.
type Config struct {
	*Flags
...
// DefaultConfig returns the default bricsd configuration
...
//
// The above results in bricsd functioning properly without any config settings
